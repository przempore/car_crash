...
::grpc::Status
    CCGRPCService::GetNewId(::grpc::ServerContext *,
...
::grpc::Status
CCGRPCService::GetVehicles(::grpc::ServerContext *,
                                          const ::google::protobuf::Empty *,
...
::grpc::Status
CCGRPCService::UpdateVehicle(::grpc::ServerContext *,
...
::grpc::Status
CCGRPCService::RegisterVehicle(::grpc::ServerContext *,
                               const ::carcrash::VehicleWithId *request,
                               ::carcrash::Id *) {
  const auto &id = request->id();
...
Server::Server(std::string server_address)
    : server_address_{std::move(server_address)}, service_{}, server_{nullptr},
      latest_id_{0} {}
